...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Repository  for formal models\\ Event-B, TLA \ldots}
...
You can find  models that  I have developed  using the Rodin platform
for Event-B modelling langauge or using  TLA modelling language. You
can use them  if you want  but you should mention  that you use them.
...
\section{Rodin Archives}

\begin{itemize}

 
\item To be continued
%\item[] \href{https://mery54.github.io/eventb/}{
